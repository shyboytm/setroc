        ...
        <div className="flex-ns w-100 bottom-0 top-auto z-1">
          ...
          <div className="flex items-center pr4-ns">
            <div className="ma0 pa0 flex hover-dropdown relative pointer">
              <a href="https://dribbble.com/fromcortes" target="_blank" rel="nofollow" className="f6 link no-underline rainbow-hover black mb0-ns mb4 fw6">
                Extras ↓
              </a>
            ...
            <a href="https://dribbble.com/fromcortes" target="_blank" rel="nofollow" className="f6 link flex no-underline rainbow-hover black mb0-ns mb4 ml4-ns ml3 fw6">
              Recent Work ↗
            </a>
            ...
            <a href="https://blog.cortes.us" target="_blank" rel="nofollow" className="f6 link flex no-underline rainbow-hover black mb0-ns mb4 ml4-ns ml3 fw6">
              Blog ↗
            </a>
            <Link to="/about" className="f6 link flex mb0-ns mb4 rainbow-hover black ml4-ns ml3 fw6">
              About
            </Link>
          </div>
        </div>
