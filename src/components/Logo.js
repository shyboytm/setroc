...
class Logo extends Component {
  render() {
    return (
      <svg viewBox="0 0 45 45" width="22" height="22" className="mt0">
        <path fill="rgba(256,256,256,.5)" d="M40.1,5C37.6,2.4,34.2,1,30.6,1c-3.1,0-6,1-8.4,2.9C19.8,2,16.9,1,13.8,1c-3.6,0-7,1.4-9.5,3.9
