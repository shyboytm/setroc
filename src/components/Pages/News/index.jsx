...
class News extends Component {
  render() {
    ...
    const pageName = "Journal";
    const pageDescription = "A place for me to keep track of updates on my work life and other random thoughts that don't fit on my main blog.";
      ...
      <div id={pageName} className="black pt4-l">
        ...
        <div className="pb5">
          <ul className="center list pl0 w-90">
            <NewsItem
              date="Jul 5 2018"
              linkTo="/journal/hm-03-is-out-everywhere-now"
