        ...
        <div className="w-50-l w-75-m w-90 center mv5-ns mv4 ph0-ns ph3 z-0 tc">
          ...
          <ul className="list ph0 pv4">
            <li className="dib mr3">
              <a href="#Setup" target="_blank" rel="nofollow" className="items-center flex f6 fw4 br-pill db pv2 ph3 link black bg-black-10 hover-bg-black-20">
            ...
            <li className="dib mr3">
              <a href="#Setup" target="_blank" rel="nofollow" className="items-center flex f6 fw4 br-pill db pv2 ph3 link black bg-black-10 hover-bg-black-20">
                <svg className="mr2" xmlns="http://www.w3.org/2000/svg" fill="rgba(0,0,0,1.0)" width="18" height="18" viewBox="0 0 16 26">
                  ...
                  <path d="M19,6.59V6a3,3,0,0,0-6,0v.59A8,8,0,0,0,8,14V27a2,2,0,0,0,2,2H22a2,2,0,0,0,2-2V14A8,8,0,0,0,19,6.59ZM14,6a2,2,0,0,1,4,0v.26a7.76,7.76,0,0,0-4,0Zm-1,6a1,1,0,0,1,1-1h4a1,1,0,0,1,1,1v1a1,1,0,0,1-1,1H14a1,1,0,0,1-1-1Zm9,9H20v2a1,1,0,0,1-2,0V21H10V20H22Z" transform="translate(-8 -3)"/>
                </svg>
                Every Day
              </a>
            </li>
