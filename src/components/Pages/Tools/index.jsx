  ...
  render() {
    ...
    return (
      <div id="Tools" className="animated fadeIn black">
        <div className="bg-dot-grid bg-pinkish">
          <div className="w-90-ns w-100 center pt5-ns pv4 ph0-ns ph3 z-0 tl">
            <h1 className="f1-ns f2 fw6 lh-title blur-late pinkish">Tools</h1>
            ...
            <Title title="Last Updated Jan 13th" />
            {/* Shortcuts */}
            <ul className="list ph0 pv4-ns pv3 tc">
              <li className="dib mr3">
                <a href="#Setup" className="items-center flex f7 fw5 mb3 br-pill db pv1 ttu tracked ph3 link black bg-white shadow-small dim">
              ...
              <li className="dib mr3">
                <a href="#EveryDay" className="items-center flex f7 fw5 mb3 br-pill db pv1 ttu tracked ph3 link black bg-white shadow-small dim">
              ...
              <li className="dib mr3">
                <a href="#Apps" className="items-center flex f7 fw5 mb3 br-pill db pv1 ttu tracked ph3 link black bg-white shadow-small dim">
              ...
              <li className="dib mr3">
                <a href="#Gaming" className="items-center flex f7 fw5 mb3 br-pill db pv1 ttu tracked ph3 link black bg-white shadow-small dim">
              ...
              <li className="dib mr3">
                <a href="#Coffee" className="items-center flex f7 fw5 mb3 br-pill db pv1 ttu tracked ph3 link black bg-white shadow-small dim">
